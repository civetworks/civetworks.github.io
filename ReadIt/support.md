...
Tingting and four preset voices are normally listed. Two additional voices are restricted to approved OpenRouter accounts, so not every account sees the same list.
